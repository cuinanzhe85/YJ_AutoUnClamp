...
namespace Common.Mvvm
{
	...
	public abstract class BaseMainControlViewModel : BaseControlViewModel
	{
		...
		public Type CurrentModuleType
		{
			...
			set { SetValue<Type>(ref currentModuleType, value); }
		}
		/// <summary>
		...
		public IModule CurrentModule
		{
			...
			set { SetValue<IModule>(ref currentModule, value); }
		}
		/// <summary>
		/// Model 객체 컬렉션
		/// </summary>
		public ObservableCollection<BaseControlViewModel> ModelCollection
		{
			...
			set { SetValue<ObservableCollection<BaseControlViewModel>>(ref modelCollection, value); }
		}
